...
def create_database(connection):
    ...
    cur.execute("""CREATE TABLE users (email varchar(100),salt varchar(100),hash varchar(100),fullname varchar(100),twittername varchar(100),redditname varchar(100), instagramname varchar(100),foreign key (twittername) references twitter(username))""")
